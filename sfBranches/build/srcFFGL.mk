...
# 2. Find and Replace the string "FFGL" with a name that describes the source folder you are adding.
...
FFGL_SRC_DIR = ${OF_ROOT}/addons/ofxFFGLPlugin/libs/FFGL
...
FFGL_OBJ_BASE_DIR := ${FFGL_SRC_DIR}/../${shell basename ${FFGL_SRC_DIR}}_obj
...
OBJS_BASE_DIRS += ${FFGL_OBJ_BASE_DIR}
OBJS_DIRS += ${FFGL_OBJ_DIR}
...
FFGL_SRC_DEFINES = ${DEFINES} -DTARGET_OS_MAC
FFGL_SRC_COMPILE_FLAGS = ${COMPILE_FLAGS} -w
...
${FFGL_OBJ_DIR}/%.o: ${FFGL_SRC_DIR}/%.cpp
	@echo 'Building file: $<'
	@echo '------------------------------'
	${MKDIR} ${FFGL_OBJ_DIR}
	${CC} ${FFGL_SRC_DEFINES} ${INCLUDE_DIRS} ${FFGL_SRC_COMPILE_FLAGS} -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o"$@" "$<"
	@echo '------------------------------'
