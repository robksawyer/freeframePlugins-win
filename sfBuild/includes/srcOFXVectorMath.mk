...
# 2. Find and Replace the string "OFXVECTORMATH" with a name that describes the source folder you are adding.
...
OFXVECTORMATH_SRC_DIR = ${OF_ROOT}/addons/ofxVectorMath/src
...
OFXVECTORMATH_OBJ_BASE_DIR := ${OFXVECTORMATH_SRC_DIR}/../${shell basename ${OFXVECTORMATH_SRC_DIR}}_obj
...
OBJS_BASE_DIRS += ${OFXVECTORMATH_OBJ_BASE_DIR}
OBJS_DIRS += ${OFXVECTORMATH_OBJ_DIR}
...
OFXVECTORMATH_SRC_DEFINES = ${DEFINES} -DTARGET_OS_MAC
OFXVECTORMATH_SRC_COMPILE_FLAGS = ${COMPILE_FLAGS} -w
...
${OFXVECTORMATH_OBJ_DIR}/%.o: ${OFXVECTORMATH_SRC_DIR}/%.cpp
	@echo 'Building file: $<'
	@echo '------------------------------'
	${MKDIR} ${OFXVECTORMATH_OBJ_DIR}
	${CC} ${OFXVECTORMATH_SRC_DEFINES} ${INCLUDE_DIRS} ${OFXVECTORMATH_SRC_COMPILE_FLAGS} -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o"$@" "$<"
	@echo '------------------------------'
